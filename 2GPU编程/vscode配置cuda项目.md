...
# 定义函数来添加 CUDA 示例
function(add_cuda_sample exe_name src_file)
    add_executable(${exe_name} ${src_file})
    target_link_libraries(${exe_name} -lglut -lGLU -lGL)
endfunction()

# 添加你的 CUDA 文件
add_cuda_sample(c3 c3.cu)
add_cuda_sample(c4 c4.cu)
```
...
```
{
    ...
    "configurations": [
        {
            "name": "CMake Debug: ${command:cmake.launchTargetName}",
            "type": "cuda-gdb",
            "request": "launch",
            ...
            "cwd": "${workspaceFolder}",
            "environment": [],
            "preLaunchTask": "CMake Build" // 这里关联上面的任务
        }
    ]
}
```
...
1.CMake:select a kit,选择第二个作为GCC编译器

![image-20260430101119923](D:\proj\LittelWidgets\2GPU编程\vscode远程244.assets\image-20260430101119923.png)

2.CMake: Configure进行配置,直接运行了

3.CMake: Set Build Target, 这步可以选择ALL

4.1,CMake:set Launch/Debug Target

![image-20260430103242131](D:\proj\LittelWidgets\2GPU编程\vscode远程244.assets\image-20260430103242131.png)

4.2使用左边侧栏选择启动哪个项目

![image-20260430102022964](D:\proj\LittelWidgets\2GPU编程\vscode远程244.assets\image-20260430102022964.png)
